    ...
    if($dyp_user_id == '' && $dyp_company_id == ''){
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        if($login == null){
          ...
          // echo 'null not';
          $this->session->set_userdata('dyp_user_id', $login[0]['user_id']);
          $this->session->set_userdata('dyp_company_id', $login[0]['company_id']);
          $this->session->set_userdata('dyp_role_id', $login[0]['role_id']);
...
/**************************      Company Information      ********************************/
  ...
  public function company_information_list(){
    ...
    $data['company_list'] = $this->User_Model->get_list($dyp_company_id,'company_id','ASC','company');
...
/*******************************  Branch Information  ****************************/
  ...
  public function branch_information_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['branch_list'] = $this->User_Model->get_list($dyp_company_id,'branch_name','ASC','branch');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function edit_branch($branch_id){
    ...
    $dyp_company_id = $this->session->userdata('dyp_company_id');
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_branch_id == ''){ header('location:'.base_url().'User'); }
...
/********************************************* Service Information ******************************************/
  ...
  public function service_information_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['service_list'] = $this->User_Model->get_list($dyp_company_id,'service_id','ASC','service');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function edit_service($service_id){
    ...
    $dyp_company_id = $this->session->userdata('dyp_company_id');
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_service_id == ''){ header('location:'.base_url().'User'); }
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['service_addedby'] = $dyp_user_id;
...
/*******************************    User Information      ****************************/
  ...
  public function user_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['user_list'] = $this->User_Model->user_list($dyp_company_id);
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function add_user(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $dyp_company_id;
      $save_data['user_addedby'] = $dyp_user_id;
    ...
    $data['group_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','group_name','ASC','group');
    $data['role_list'] = $this->User_Model->get_list_by_id('','','','','role_name','ASC','role');
    $data['branch_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','branch_name','ASC','branch');
    $this->load->view('Include/head', $data);
    $this->load->view('Include/navbar', $data);
  ...
  public function edit_user($user_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['company_id'] = $dyp_company_id;
      $update_data['user_addedby'] = $dyp_user_id;
...
/*******************************  Unit Information  ****************************/
  ...
  public function unit_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['unit_list'] = $this->User_Model->get_list($dyp_company_id,'unit_name','ASC','unit');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function unit(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $dyp_company_id;
      $save_data['unit_addedby'] = $dyp_user_id;
...
/********************************************** Issue Information  ***********************************/
  ...
  public function issue_information_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['issue_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','issue_id','DESC','issue');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function issue_information(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['issue_addedby'] = $dyp_user_id;
    ...
    $data['service_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'service_status','1','service_name','ASC','service');
    $this->load->view('Include/head', $data);
    $this->load->view('Include/navbar', $data);
  ...
  public function edit_issue($issue_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['issue_addedby'] = $dyp_user_id;
...
/********************************************** Service Contract *************************************/
  ...
  public function service_contract_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['service_contract_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','ser_cont_id','DESC','service_contract');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function service_contract(){
    ...
    if ($this->form_validation->run() != FALSE) {
      $save_data = $_POST;
      $save_data['company_id'] = $dyp_company_id;
      $save_data['ser_cont_addedby'] = $dyp_user_id;
  ...
  public function edit_service_contract($ser_cont_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      $update_data = $_POST;
      $update_data['ser_cont_addedby'] = $dyp_user_id;
...
/************************************************* Party *******************************************************/
  ...
  public function party_information_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['party_list'] = $this->User_Model->get_list($dyp_company_id,'party_id','DESC','party');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function party_information(){
    ...
    $dyp_company_id = $this->session->userdata('dyp_company_id');
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    $dyp_branch_id = $this->session->userdata('dyp_branch_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['party_addedby'] = $dyp_user_id;
    ...
    if($dyp_role_id == 1){
      ...
      $data['branch_list'] = $this->User_Model->get_branch_list($dyp_branch_id);
    }
  ...
  public function edit_party($party_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['party_addedby'] = $dyp_user_id;
...
/*******************************  Group Information  ****************************/
  ...
  public function group_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['group_list'] = $this->User_Model->get_list($dyp_company_id,'group_id','ASC','group');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function group(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $dyp_company_id;
      $save_data['group_addedby'] = $dyp_user_id;
