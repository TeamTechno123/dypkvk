...
/******************************************* Task ************************************/
  ...
  public function task_information_list(){
    ...
    $data['task_list'] = $this->User_Model->get_list($dyp_company_id,'task_id','DESC','task');
  ...
  public function task_information(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['task_addedby'] = $dyp_user_id;
  ...
  public function edit_task($task_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['task_addedby'] = $dyp_user_id;
...
/************************************************ Ticket Information *************************************/
  ...
  public function ticket_information_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['ticket_list'] = $this->User_Model->get_list($dyp_company_id,'ticket_id','DESC','ticket');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function ticket_information(){
    ...
    if ($this->form_validation->run() != FALSE) {
      $save_data = $_POST;
      $save_data['company_id'] = $dyp_company_id;
      $save_data['ticket_addedby'] = $dyp_user_id;
    ...
    $data['ticket_no'] = $this->User_Model->get_count_no($dyp_company_id, 'ticket_no', 'ticket');
  ...
  public function edit_ticket($ticket_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      $update_data = $_POST;
      $update_data['ticket_addedby'] = $dyp_user_id;
...
/********************************************** Lead Information ********************************************/
  ...
  public function lead_information_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['lead_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','lead_id','DESC','lead');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function lead_information(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $dyp_company_id;
      $save_data['lead_addedby'] = $dyp_user_id;
    ...
    $data['lead_no'] = $this->User_Model->get_count_no($dyp_company_id, 'lead_no', 'lead');
  ...
  public function edit_lead($lead_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['lead_addedby'] = $dyp_user_id;
...
/****************************************************** Project Contract Information ***************************************/
  ...
  public function project_contract_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['project_contract_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','pro_cont_id','DESC','project_contract');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function project_contract(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $dyp_company_id;
      $save_data['pro_cont_addedby'] = $dyp_user_id;
    ...
    $data['pro_cont_no'] = $this->User_Model->get_count_no($dyp_company_id, 'pro_cont_no', 'project_contract');
  ...
  public function edit_project_contract($pro_cont_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      unset($update_data['input']);
      unset($update_data['pro_cont_file_name']);
      $update_data['pro_cont_addedby'] = $dyp_user_id;
...
/********************************************* Attendence Information ***********************************/
  ...
  public function attendence_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['attendence_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','attendance_id','DESC','attendance');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function attendence(){
    ...
    if ($this->form_validation->run() != FALSE) {
      $save_data = $_POST;
      $save_data['company_id'] = $dyp_company_id;
      $save_data['attendance_addedby'] = $dyp_user_id;
...
/******************************************* Receipt *****************************************/
  ...
  public function receipt_list(){
    ...
    $dyp_role_id = $this->session->userdata('dyp_role_id');
    if($dyp_user_id == '' && $dyp_company_id == ''){ header('location:'.base_url().'User'); }
    $data['receipt_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','receipt_id','DESC','receipt');
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
  ...
  public function receipt(){
    ...
    if ($this->form_validation->run() != FALSE) {
      $save_data = $_POST;
      $save_data['company_id'] = $dyp_company_id;
      $save_data['receipt_addedby'] = $dyp_user_id;
    ...
    $data['receipt_no'] = $this->User_Model->get_count_no($dyp_company_id, 'receipt_no', 'receipt');
    $data['party_list'] = $this->User_Model->get_list_by_id('company_id',$dyp_company_id,'','','party_name','ASC','party');
  ...
  public function edit_receipt($receipt_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      $update_data = $_POST;
      $update_data['receipt_addedby'] = $dyp_user_id;
