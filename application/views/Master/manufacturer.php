              ...
              <div class="col-md-5">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New Manufacturer</h5>
                  </div>
                  <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                    <div class="card-body row">
                      <div class="form-group col-md-12">
                        <label>Enter Manufacturer Name</label>
                        <input type="text" class="form-control form-control-sm" name="manufacturer_name" id="manufacturer_name" value="" placeholder="Enter Manufacturer Name" required>
                      </div>
