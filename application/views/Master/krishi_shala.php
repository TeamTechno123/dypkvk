      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card collapsed-card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Add New कृषी शाळा </h3>
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <select class="form-control select2" name="category_id" id="category_id" data-placeholder="Select Main Category">
                              <option value=""> Select Main Category</option>
                            </select>
                          </div>

                          <div class="form-group col-md-12 select_sm">
                            <label>Enter Krishi Shala Title</label>
                            <input type="text" class="form-control form-control-sm" name="title" id="title"  placeholder="Enter Krishi Shala Title" required>
                          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All कृषी शाळा </h3>
              </div>
