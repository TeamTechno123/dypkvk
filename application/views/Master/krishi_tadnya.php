      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card collapsed-card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Add New कृषी तज्ञ </h3>
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 select_sm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="author" id="author"  placeholder=" Author Name" required>
                          </div>
                          <div class="form-group col-md-6 select_sm">
                            <label>Organization Name</label>
                            <input type="text" class="form-control form-control-sm" name="date" id="date"  placeholder="Organization Name" required>
                          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All कृषी तज्ञ </h3>
              </div>
