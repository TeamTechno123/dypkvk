      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card collapsed-card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Add New पशू शाळा </h3>
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 select_sm">
                            <label>Enter Pashu Shala Title</label>
                            <input type="text" class="form-control form-control-sm" name="title" id="title"  placeholder="Enter Pashu Shala Title" required>
                          </div>
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <textarea class="form-control" name="name" rows="5" cols="85"></textarea>
                          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All पशू शाळा </h3>
              </div>
