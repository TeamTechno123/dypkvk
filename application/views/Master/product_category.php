          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New Product Category</h5>
                  </div>
                  <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                    <div class="card-body row">
                      <div class="form-group col-md-12 select_sm">
                          <label>Select Manufacturer Name </label>
                          <select class="form-control select2" name="manufacturer_id" id="manufacturer_id" data-placeholder="Select Manufacturer Name ">
                        ...
                        <div class="form-group col-md-12">
                          ...
                          <input type="text" class="form-control form-control-sm" name="product_category" id="product_category" value="" placeholder="Enter Product Category Name" required>
                        </div>
              ...
              <div class="col-md-7">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16">List All Product Category</h5>
                  </div>
